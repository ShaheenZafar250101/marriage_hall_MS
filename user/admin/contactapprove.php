                  ...
                  <form action ="" method ="POST">
                    ...
                    <div class="card-body">
                      <div class="form-group mb-0">
                        <label>Message</label>
                        <input type="hidden" name="id" value="<?php echo $_POST["uid"];?>" class="form-control" required="">
                        <input type="hidden" name="email" value="<?php echo $_POST["uemail"];?>" class="form-control" required="">
...
if(isset($_POST['sub']))
{
  ...
  $sql = "UPDATE contact SET status = 'approved', replay = '$message' WHERE email = '$email' && id='$id'";
...
require 'phpmailer/PHPMailerAutoload.php';
		...
		$mail->ADDCC($email,"event planner");
		$mail->WordWrap = 50;
		//$mail->addAttachment($docs); 
		$mail->IsHTML(true);
		$mail->Subject = "thanks for connecting us";
		$mail->Body = $message;
		if($mail->Send())
		{
