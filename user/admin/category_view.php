          ...
          <div class="section-body">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="category_update.php?uid=<?php echo $row['cid'] ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="category_delete.php?uid=<?php echo $row['cid'] ?>" class="btn btn-warning">Delete</a></td>
                </tr>
            <?php
            }
            ?>
