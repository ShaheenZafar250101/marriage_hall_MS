  ...
  <br>
            ...
            ?>
                <tr>
                    ...
                    <td><form action ="contactapprove.php" method ="POST">
                    <input type = "hidden" name  ="uid" value = "<?php echo $row['id'];?>"/>
                    <input type = "hidden" name  ="uemail" value = "<?php echo $row['email'];?>"/>
                                <input type = "submit" class="btn btn-primary" name  ="replied" value = "Reply"/>
                                
                            </form></td>
                   
                    <td><a href="contactdelete.php?uid=<?php echo $row['id']?>" class="btn btn-warning delete">Delete</button></td>
                </tr>
            <?php
            }
            ?>
