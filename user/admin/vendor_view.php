          ...
          <div class="section-body">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="vendor_update.php?uid=<?php echo $row['vid'] ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="vendor_delete.php?uid=<?php echo $row['vid'] ?>" class="btn btn-warning">Delete</a></td>
                </tr>
            <?php
            }
            ?>
