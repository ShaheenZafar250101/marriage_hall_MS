          ...
          <div class="section-body">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped table-hover" id="tableExport2" style="width:100%;">
                        ...
                        <tbody>
                        <?php
            $sql = "SELECT * FROM menu INNER JOIN category ON category.cid = menu.cid";
            ...
            ?>
                ...
                <td><?php echo $row['name'] ?></td>
                    ...
                    <td><a href="menu_update.php?uid=<?php echo $row['mid'] ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="menu_delete.php?uid=<?php echo $row['mid'] ?>" class="btn btn-warning">Delete</a></td>
                </tr>
            <?php
            }
            ?>
