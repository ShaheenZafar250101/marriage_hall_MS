          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                ...
                $sql = "SELECT DISTINCT item, SUM(quantity) AS quantity, SUM(price) AS price,vendor.name, MAX(purchase_date) AS purchase_date
                FROM saman
                INNER JOIN vendor ON vendor.vid = saman.vid
                INNER JOIN hall ON hall.hid = saman.hid
                GROUP BY item;
                ";
