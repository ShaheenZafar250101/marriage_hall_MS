          ...
          <div class="section-body">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="hall_update.php?uid=<?php echo $row['hid'] ?>" class="btn btn-primary">Update</a></td>
                    <td><a href="hall_delete.php?uid=<?php echo $row['hid'] ?>" class="btn btn-warning">Delete</a></td>
                </tr>
            <?php
            }
            ?>
